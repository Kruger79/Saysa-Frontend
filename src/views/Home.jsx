      ...
      <section className="home-section">
        ...
        <div className="about-section">
          <div className="about-text">
            <h1>¿Quiénes somos?</h1>
            <p>
              Soluciones SaYsa es la conexión primaria que conecta el ámbito agrícola bananero y piñero,
              automatizando el proceso de importación de manera eficiente.
            </p>
          </div>

          <div className="about-image">
            <img src="https://i.pinimg.com/736x/ef/26/c7/ef26c79cf9004f1faa245a02c8dd6a84.jpg" alt="Banano" />
          </div>
        </div>
